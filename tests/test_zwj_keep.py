...
def test_non_rgi_zwj_replace():
    ...
    assert emoji.replace_emoji(u'\U0001F468\u200d\U0001F469\U0001F3FF\u200d\U0001F467\U0001F3FB\u200d\U0001F466\U0001F3FE', 'X') == u'X'

    assert emoji.replace_emoji(u'\U0001F468\U0001F3FF\u200d\U0001F469\U0001F3FF\u200d\U0001F467\U0001F3FB\u200d\U0001F466\U0001F3FE', '') == u''
    assert emoji.replace_emoji(u'\U0001F468\U0001F3FF\u200d\U0001F469\U0001F3FF\u200d\U0001F467\U0001F3FB\u200d\U0001F466\U0001F3FE', 'X') == u'X'

    assert emoji.replace_emoji(u'\U0001F468\U0001F3FF\u200d\U0001F469\u200d\U0001F467\U0001F3FB\u200d\U0001F466', '') == u''
    assert emoji.replace_emoji(u'\U0001F468\U0001F3FF\u200d\U0001F469\u200d\U0001F467\U0001F3FB\u200d\U0001F466', 'X') == u'XX'

    assert emoji.replace_emoji(u'\U0001f3ff\U0001f476\u200d\U0001f6d1', 'X') == u'XX'

    assert emoji.replace_emoji(u'\U0001f476\U0001f3ff\u0308\u200d\U0001f476\U0001f3ff', 'X') == u'X\u0308\u200dX'
    ...
    assert emoji.replace_emoji(u'A\U0001F468\u200d\U0001F469\U0001F3FF\u200d\U0001F467\U0001F3FB\u200d\U0001F466\U0001F3FE\U0001f468\U0001f3fb\u200d\U0001f469\U0001f3fc\u200d\U0001f467\U0001f3fe\U0001f469\U0001f3feB', replace_f) == u'AyyyXyyyB'
